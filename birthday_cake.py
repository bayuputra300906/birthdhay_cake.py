...
screen.bgcolor("lightblue")  # Warna background

# Buat turtle object untuk menggambar
pen = turtle.Turtle()
pen.speed(2)  # Kecepatan menggambar
...
pen.penup()
pen.goto(-100, -100)  # Lokasi di mana kue dimulai
pen.pendown()
...
pen.pendown()
pen.color("purple")
pen.write("Happy Birthday for RISKA", font=("Riska", 18, "bold"))
